...
my_ingredients = ['Motor Oil', 'Cuke', 'Paracetamol', 'Gasoline', 'Cuke', 'Battery', 'Mega Bean']
...
print("Which Product? OG K / Sour D / Green C / Grandaddy P / Meth / Cocaine")
product = input()
print(apply_effects(my_ingredients, products[product]["effects"][:]))